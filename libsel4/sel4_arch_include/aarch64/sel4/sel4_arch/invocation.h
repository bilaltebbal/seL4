...
enum sel4_arch_invocation_label {
    ARMPageGlobalDirectoryClean_Data = nInvocationLabels,
    ARMPageGlobalDirectoryInvalidate_Data,
    ARMPageGlobalDirectoryCleanInvalidate_Data,
    ARMPageGlobalDirectoryUnify_Instruction,
